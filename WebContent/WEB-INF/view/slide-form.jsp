              ...
              <form:hidden path="id"/>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <form:input path="linkName" type="text" class="form-control" placeholder="Enter link name"/>
                  </div>
              
                  <div class="form-group">
                    <label>Link</label>
                    <form:input path="linkPath" type="text" class="form-control" placeholder="Enter URL"/>
                  </div>
