					...
					<div class="row">
						<div class="col-md-6">
							<div class="card card-primary">
								...
								<form:form role="form"
									action="blog-save" modelAttribute="blog">
									...
									<div class="card-body">
										...
										<div class="form-group">
											...
											<form:textarea path="description" type="text" class="form-control" rows="3" placeholder="Enter description"></form:textarea>
										...
										<div class="mb-3">
                				<form:textarea path="textArea" id="compose-textarea" class="textarea" placeholder="Place some text here" rows="6"
                        			  style="width: 100%; height: 600px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></form:textarea>
             					 </div>
             						 </div>
										<div class="form-group">
										<label>Image</label>
